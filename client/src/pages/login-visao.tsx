...
const loginSchema = z.object({
  username: z.string().min(1, { message: "Email ou username obrigatório" }),
...
export default function LoginVisao() {
  ...
  const loginForm = useForm<LoginFormValues>({
    ...
    defaultValues: {
      username: "cliente@visaomais.com",
      password: "user123",
    },
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-orange-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <Card className="backdrop-blur-sm bg-white/95 shadow-2xl border-0 overflow-hidden">
            ...
            >
              ...
              >
                <div className="flex items-center justify-center h-16 mb-4">
                  {/* Logo Visão+ Horizontal ORIGINAL */}
                  <img 
                    src="/logo-visao-horizontal.png"
                    alt="Visão+ Logo" 
          ...
          <CardContent>
            {/* Acesso Rápido - Movido para cima */}
            <div className="mb-6 pb-6 border-b border-gray-200">
              <p className="text-center text-sm text-gray-600 mb-4 font-medium">Acesso Rápido por Tipo de Usuário</p>
              <div className="grid grid-cols-3 gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="h-12 border-purple-200 text-purple-600 hover:bg-purple-50 hover:border-purple-300"
                  onClick={() => {
                    // Preenche dados de admin automaticamente
                    loginForm.setValue('username', 'admin@visaomais.com');
                    loginForm.setValue('password', '123456');
                    registerForm.setValue('user_type', 'admin');
                    registerForm.setValue('username', 'admin@visaomais.com');
                    registerForm.setValue('name', 'Administrador Visão+');
                    registerForm.setValue('phone', '(11) 99999-0001');
                    registerForm.setValue('cpf', '111.111.111-11');
                  }}
                >
                ...
                <Button
                  ...
                  onClick={() => {
                    // Preenche dados de franqueado automaticamente
                    loginForm.setValue('username', 'franquia@visaomais.com');
                    loginForm.setValue('password', '123456');
                    registerForm.setValue('user_type', 'franchisee');
                    registerForm.setValue('username', 'franquia@visaomais.com');
                    registerForm.setValue('name', 'Franqueado Visão+');
                    registerForm.setValue('phone', '(11) 99999-0002');
                    registerForm.setValue('cpf', '222.222.222-22');
                  }}
                >
                ...
                <Button
                  ...
                  onClick={() => {
                    // Preenche dados de cliente automaticamente
                    loginForm.setValue('username', 'cliente@visaomais.com');
                    loginForm.setValue('password', '123456');
                    registerForm.setValue('user_type', 'client');
                    registerForm.setValue('username', 'cliente@visaomais.com');
                    registerForm.setValue('name', 'Cliente Visão+');
                    registerForm.setValue('phone', '(11) 99999-0003');
                    registerForm.setValue('cpf', '333.333.333-33');
                  }}
                >
